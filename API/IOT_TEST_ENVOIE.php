...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (isset($postdata) && !empty($postdata)) {
        ...
        if (isset($request->gel_percentage, $request->battery_percentage, $request->numeroESP, $request->etablissement)) {
            ...
            try {
                ...
                $sql = "INSERT INTO borne (Niveau_Gel, Niveau_Batterie, IdBorne, Id_Etablissement) 
                        VALUES (:gel, :battery, :id, :etablissement) 
            ...
            // En cas de données manquantes, réponse JSON avec un message d'erreur
