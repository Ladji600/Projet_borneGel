...
if(isset($_GET['id_etablissement'])) {
    ...
    try {
        ...
        // Créer la requête SQL pour récupérer les bornes de l'établissement avec un niveau de gel ou de batterie supérieur à 10
        ...
        AND CAST(Niveau_Gel AS UNSIGNED) > 10 
        AND CAST(Niveau_Batterie AS UNSIGNED) > 10";
