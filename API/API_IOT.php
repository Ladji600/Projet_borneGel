...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($postdata) && !empty($postdata)) {
        ...
        try {
            ...
            // Requête SQL d'insertion des données dans la table "borne"
            ...
            // Réponse JSON pour confirmer l'insertion
            ...
            echo json_encode(array("message" => "Erreur lors de l'insertion des données : " . $e->getMessage()));
        }
    } else {
