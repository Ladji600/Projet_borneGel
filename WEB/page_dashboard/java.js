...
function fetchBorneData() {
    fetch("http://51.210.151.13/btssnir/projets2024/bornegel2024/bornegel2024/SmartGel/API/ConfigConnexion.php")
        .then(response => {
            if (!response.ok) {
        ...
        .then(data => {
           ...
           // Après avoir affiché les données des bornes avec succès
